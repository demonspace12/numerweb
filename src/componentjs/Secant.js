            ...
            <div>
                <div className='box'>
                    ...
                    <div>
                        ...
                        <span > X0 =</span><br />
                        <span><Input placeholder="" className="data" onChange={this.getx0} value={this.state.x0} /></span>
                        <span > X1 =</span><br />
                        <span><Input placeholder="" className="data" onChange={this.getx1} value={this.state.x1} /></span>
                        <span > ERROR : </span><br />
